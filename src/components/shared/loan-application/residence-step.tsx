...
import type { CustomFormConfig } from "../../../types/customForm"
...
export function ResidenceStep({ form, config, stepId }: ResidenceStepProps) {
  ...
  return (
    <div className="space-y-6">
      {isFieldVisible("residencyStatus") && (
        <FormField
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {isFieldVisible("yearsAtCurrentAddress") && (
          <FormField
            control={form.control}
      ...
      {isFieldVisible("previousAddress") &&
        watchYearsAtAddress !== undefined &&
        watchYearsAtAddress < 2 && (
          <FormField
            control={form.control}
