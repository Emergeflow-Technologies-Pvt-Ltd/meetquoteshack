            ...
            <div className="text-left space-y-8">
              ...
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Skip the paperwork and long wait times. Get matched with the perfect loan option in minutes, 
                  with competitive rates and flexible terms tailored to your needs.
                </p>
              </div>
              ...
              <div className="relative bg-white p-8 rounded-2xl shadow-xl">
                <div className="space-y-8">
                  <div className="flex items-center justify-between pb-6 border-b">
                    ...
                    <div>
                      <p className="text-lg font-semibold text-gray-900">Monthly Payment</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-gray-900">5.99% APR</span>
                    </div>
                    <div className="flex justify-between items-center">
