          ...
          <div className="max-w-3xl text-center lg:text-start">
            ...
            <div className="mt-10 flex items-center gap-6 justify-center md:justify-start">
              <div className="flex -space-x-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-200 to-blue-200 border-2 border-white" />
                ))}
              </div>
              <div className="text-sm">
                <p className="font-semibold text-gray-900">Trusted by 500+ users</p>
