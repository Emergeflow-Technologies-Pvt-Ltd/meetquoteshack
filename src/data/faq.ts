const faq = {
  ...
  lenders: [
    {
      question: "How can lenders benefit from using Quoteshack?",
      answer: "Lenders can expand their loan portfolios, diversify into different types of lending, and earn high yields with predictable risks. Our platform provides tools to accurately price and predict risk, ensuring safe and profitable lending."
    },
    {
      question: "What types of businesses can apply for loans on Quoteshack?",
      answer: "Quoteshack caters to a wide range of businesses, from startups to established companies, looking for funding to grow and expand their operations."
    },
    {
      question: "How secure is the lending process on Quoteshack?",
  ...
  loanees: [
    {
      ...
      answer: "You can apply for a loan by clicking on the 'Apply Now' button and filling out the necessary information on our application form."
    },
    {
